...
class ReportController extends Controller
{
    ...
    //payment method for admin panael

    public function pay(){
        $payments=Payment::all();
        return view('admin.viewpayment',compact('payments'));
    }
    ...
    public function addPayment(Request $request){
        ...
        $data->save();
        return redirect()->back()->with('success_msg','Successfully Added');
    ...
    {
        return view('admin.editpay',compact('payment'));
    }
    ...
    public function updatePayment(Request $request, Payment $payment)
    {
        ...
        $data->number = $request->number;
        $data->save();
        return redirect('/admin/paymentall')->with('success_msg','Successfully Updated');
    }
    public function delete(Payment $payment)
    {
        $payment->delete();
        return redirect('/admin/paymentall')->with('success_msg','Successfully Deleted!');
    }
    //endpay
}

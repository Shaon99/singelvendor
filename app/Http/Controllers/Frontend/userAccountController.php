...
class userAccountController extends Controller
{
    Public Function userAccount()
    {
        ...
        $orderpayment = Order::where('user_id', $id)->latest()->select('payment')->first();
        ...
        return view('Frontend.userProfile.userAccount', compact('user' , 'orderpayment', 'orders' , 'OrderProduct','cartpage'));
    }

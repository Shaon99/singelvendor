...
<div class="cart-main-area pt-115 pb-120">
    <div class="container">
        ...
        <div class="alert text-white container" style="background: #39b54a;">
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                               ...
                               <!--@if ($content->options->color_id==0)-->
                               <!-- <td class="product-size"><a href="#">{{ '-'}}</a></td>-->
                               <!-- @else-->
                               <!-- <td class="product-size"><a href="#">{{ $content->options->color_name }}</a></td>-->
                               <!-- @endif-->
                               <!-- @if ($content->options->size_id==0)-->
                               <!-- <td class="product-size"><a href="#">{{ '-'}}</a></td>-->
                               <!-- @else-->
                    ...
                    <div class="col-lg-12">
                        <div class="cart-shiping-update-wrapper">
                            ...
                            <div class="cart-clear">
                                ...
                                <a href="{{ route('destroyauth.cart',Auth::user()) }}" class="mr-5">Clear Cart</a>
                                <a href="{{route("checkout")}}" class="text-white" style="background:#ff5900">Proceed to
                                    Checkout</a>
                            ...
                            @else
                            <div class="cart-clear">
                                <a href="{{ route('destroy.cart') }}" class="mr-5">Clear Cart</a>
                                <a href="{{route("checkout")}}" class="text-white" style="background:#ff5900">Proceed to
                                    Checkout</a>
                            </div>
                            @endif

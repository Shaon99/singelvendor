...
<body>
                    ...
                    <div class="row">
                            <div class="col-xl-4 col-lg-5">
                                <div class="header-offer-wrap">
                                    @if(!empty($header->top_heading))
                                        <p><i class="icon-paper-plane"></i>{{$header->top_heading}}</p>
                                    @endif
                                </div>
                            </div>
                                    ...
                                    <div class="same-style-wrap">
                                        ...
                                        @if(!empty($header->lang))
                                            <div class="same-style same-style-border language-wrap">
                                                <a class="language-dropdown-active" href="#">{{$header->lang}}</a>
                                            </div>
                                        @endif
                                        @if(!empty($header->curr))
                                            <div class="same-style same-style-border currency-wrap">
                                                <a class="currency-dropdown-active" href="#">{{$header->curr}}</a>
                                            </div>
                                        @endif
                                    </div>
                                    @if(!empty($contacts))
                            ...
                            <div class="col-xl-3 col-lg-3">
                                <div class="header-action header-action-flex">
                                    @guest
                                        ...
                                        <div class="wishlistcounter same-style-2 same-style-2-font-inc">
                                            <a href="{{ route('wishlist.view') }}"><i class="icon-heart"></i><span
                                                    class="pro-count purple">{{ $wishlist_num }}</span></a>
                                        </div>
                ...
                <div class="header-bottom header-bottom-ptb">
                    <div class="container">
                        <div class="row align-items-center">
                            ...
                            @if(!empty($header))
                            <div class="col-lg-3">
                                <div class="header-offer-wrap-5" style="overflow: hidden;">
                                    <h3> @if(!empty($header)) {{$header->bannar_offer}} @endif</h3>
                                    <h4> @if(!empty($header)) {{$header->bannar_text}} @endif </h4>
                                </div>
                            </div>
                            @endif
                            <!-- offer -->
                ...
                <div class="mobile-header-content-area">
                    ...
                    @if(!empty($header->lang))
                        <div class="single-mobile-header-info">
                            <a class="mobile-language-active" href="#">{{$header->lang}}</a>
                        </div>
                        @endif
                        @if(!empty($header->curr))
                        <div class="single-mobile-header-info">
                            <a class="mobile-currency-active" href="#">{{$header->curr}} <span><i class="icon-arrow-down"></i></span></a>
                        </div>
                        @endif
    ...
    <footer style="background-color:#2D3191" class="footer-area -4">
    <div style="padding-top:50px" class="footer-top border-bottom-4 pb-10">
        <div class="container">
            <div class="row">
                <!-- Quick shop -->
    ...
    <div  class="footer-bottom pt-30 pb-30 ">
        {{-- <div class="container copy">
            <p>&copy 2021-2026. All rights reserved by Norda | <a href="#">Privacy Policy</a></p>
        </div> --}}
        @if(!empty($copyright))
        <div class="container copy">
            <p> {!! $copyright->title !!} </p>

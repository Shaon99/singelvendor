                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-4">
                            <div class="myaccount-tab-menu nav" role="tablist">
                                ...
                                <a href="#dashboad" class="" data-toggle="tab"><i class="fa fa-tachometer"></i>
                                    Dashboard</a>
                            ...
                            <div class="tab-content" id="myaccountContent">
                                            ...
                                            <table class="table table-bordered js-basic-example dataTable" id="DataTables_Table_0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{$order->date}}</td>
                                                        @if ($order->status==0)
                                                            <td><span class="badge badge-pill badge-warning">Pendeing</span></td>
                                                        @elseif ($order->status==1)
                                                            <td><span class="badge badge-pill badge-primary">Accepted</span></td>
                                                        @elseif ($order->status==2)
                                                            <td><span class="badge badge-pill badge-danger">Delivered</span>
                                                            </td>
                                                        @else <td></td>
                                                        @endif
                                ...
                                <div class="tab-pane fade" id="payment-method" role="tabpanel">
                                    <div class="myaccount-content">
                                        ...
                                        <p class="saved-message">You have used <strong>{{$orderpayment->payment}}</strong> as your last transaction
                                            payment method.</p>
                                        @else
                                        <p class="saved-message">You havenot used any <strong>transaction</strong> yet.</p>
                                        @endif
                                        ...
                                        <div class="account-details-form" >
                                            ...
                                            <form method="POST" action="{{ route('userUpdate') }}" enctype="multipart/form-data" >
                                                ...
                                                <div class="single-input-item">
                                                    ...
                                                    <input name="email" type="email" id="email" class="@error('email') is-invalid @enderror"  value="{{old('email',$user->email)}}"/>
                                                    @error('email')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                                ...
                                                <fieldset>
                                                    ...
                                                    <div>
                                                        <label class="">
                                                            ...
                                                            " name="gender" value="male" type="radio" {{$user->gender == 'male'?"checked":null}}>
                                                            <span><i></i>Male</span>
                                                        </label><br>
                                                        <label class="">
                                                            <input style="left: 9px;
                                                            ...
                                                            -ms-transform: rotate(45deg);
                                                            transform: rotate(45deg);
                                                            " name="gender" name="gender" value="female" type="radio" {{ $user->gender == 'female'? "checked" : null}}>

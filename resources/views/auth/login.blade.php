                            ...
                            <div class="login-form-container">
                                <div class="login-register-form">
                                    ...
                                    <form  method="post" id="registerForm" >
                                        ...
                                        <div class="form-group">
                                            <input id="reg_password" class="form-control" type="password" name="password" placeholder="Password (minimum 6 characters)" value="{{ old('password') }}" required autocomplete="new-password" autofocus>

<nav class="navbar navbar-fixed-top">
    <div class="container-fluid">
      ...
      <div class="navbar-brand">
            @if(!empty($logo))
            <a href="{{ route('admin.dashboard') }}"><img src="{{ (!empty($logo->image))?url('upload/Logo_images/'.$logo->image):url('upload/Logo_images/noImage.png') }}" alt=""
                    class="img-responsive logo" style=" max-width:200px; max-height:50px; "></a>
            @else
            <a href="{{--{{route('dashboard.ecommerce')}}--}}"><img src="{{ asset('upload/Logo_images/noImage.png') }}"

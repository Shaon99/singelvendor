...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        @if (Request::segment(2) === 'terms-and-conditions' or Request::segment(2) === 'privacy-policy' or Request::segment(2) === 'about-us' )
    ...
    <body class="<?= $theme ?>">
        ...
        <div class="page-loader-wrapper">
            <div class="loader">
                <div class="m-t-30"><img src="{{url('/')}}/assets/img/agro-logo.jpg" width="48" height="48" alt="Lucid"></div>
                <p>Please wait...</p>
            </div>
        </div>

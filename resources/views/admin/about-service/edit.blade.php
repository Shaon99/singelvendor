...
@section('pageTitle') <a href="{{route('about-service.index')}}">About Service Area</a> @endsection
@section('parentPageTitle')<a href="{{route('about-service.edit', $service->id)}}">About Service Area Edit</a> @endsection
    ...
    <div class="row clearfix">
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="header">
                    <h6>
                        About Service Area Edit

                        <a class=" float-right btn btn-success btn-sm" href="{{ route('about-service.index') }}"><i class="fa fa-list"></i>About Service Area</a>
                    </h6>
                ...
                <div class="body">
                    <form class="" action="{{ route('about-service.update', $service->id) }}" method="post">
                        @csrf
                        <div class="form-row">

...
<div id="date">
    <div class="panel panel-default">
     ...
     <a href="/admin/export" id="e" class="btn btn-primary ml-3"><i class="fa fa-file-excel-o"></i> Export Excel All</a>    
    <input type='button' class="ml-4 btn btn-primary" id='p' value='Print All Excel' onclick='printDiv();'>
     <div id="DivIdToPrint" class="table mt-1">
        <table id="d" class="ml-3 table table table-bordered table-hover table-custom ">
...
<div id="lastr" class="table">
        <table id="l" class="table table table-bordered table-hover  js-basic-example dataTable table-custom">
            <thead>
           <tr>
        <th>Order Code</th>
        <th>Date</th>
...
<table id="r" class="table table table-bordered table-hover  js-basic-example dataTable table-custom">
 <thead>
<tr>
<th>Order Code</th>
<th>Date</th>
...
<div id="sevenr" class="table">
        <table id="s" class="table table table-bordered table-hover  js-basic-example dataTable table-custom">
         <thead>
        <tr>
    <th>Order Code</th>
    <th>Date</th>
 ...
 $.ajax({
  ...
  success:function(data)
  {
   ...
   for(var count = 0; count < data.length; count++)
   {
    ...
    output += '<td>' + data[count].biling_fname+'</td>';

...
@section('pageTitle') <a href="{{route('privacy.policy.add')}}">Add Privacy Policy</a> @endsection
...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="post" action="{{ route('privacy.policy.store') }}" id="myform" enctype="multipart/form-data">
                @csrf
                <div class="form-row col-md-10">
                    <label for="content">Content</label>
                    <textarea class="summernote" id="content" class="form-control" name="content" placeholder="Write Privacy Policy" required>
                    </textarea>

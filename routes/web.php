...
Route::get('terms-and-conditions', 'Frontend\FrontendController@termsAndCond')->name('terms.and.conditions');
...
Route::post('/search-result-ajax','Frontend\SearchController@searchAjax');
...
Route::prefix('newsletter')->group(function(){
    Route::get('/view','Backend\NewsletterController@view')->name('newsletter.view');
    Route::post('/store','Backend\NewsletterController@store')->name('newsletter.store');
    Route::delete('/delete/{id}','Backend\NewsletterController@destroy')->name('newsletter.destroy');
});
...
Route::get('delete-cartajax/{rowId}', 'Frontend\CartController@deleteCartajax')->name('delete.cartajax');
Route::get('delete-cartshopping/{id}', 'Frontend\CartController@deleteAuthCart')->name('delete.authcart');
Route::get('delete-cartshoppingajax/{id}', 'Frontend\CartController@deleteAuthCartajax')->name('delete.authcartajax');
Route::delete('delete-wishlist/{id}', 'Frontend\CartController@deletewishlist')->name('delete.wishlist');
...
//Send mail route
Route::post('/contact','Frontend\sendQueryMailController@sendMail');
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::post('confirm','Frontend\CheckoutController@confirm')->name('confirm_order');
...
Route::prefix('seo')->group(function (){
        Route::get('/view','Backend\SeoController@index')->name('seo.view');
        Route::get('/add','Backend\SeoController@create')->name('seo.add');
        Route::post('/store','Backend\SeoController@store')->name('seo.store');
        // Route::get('/{seo}/edit','Backend\SeoController@edit')->name('seo.edit');
        // Route::post('/{seo}/edit','Backend\SeoController@update')->name('seo.update');
        Route::delete('/{seo}/destroy','Backend\SeoController@delete')->name('seo.delete');
    });
    ...
    Route::prefix('products')->group(function () {
        ...
        Route::post('/quick-view','Backend\ProductsController@productQuickView')->name('product.quickview');
    });
    ...
    Route::prefix('admin')->group(function () {
        ...
        Route::prefix('slider')->group(function () {
            ...
            Route::delete('/delete/{id}', 'Backend\SliderController@delete')->name('slider.delete');
        });
    });
    // category
...
//payment route
    Route::get('/payment','Backend\ReportController@addpay');
    Route::get('/paymentall','Backend\ReportController@pay')->name('allpay');
    Route::post('/addpayment','Backend\ReportController@addPayment')->name('add.pay');
    Route::get('/{payment}/edit','Backend\ReportController@editPayment')->name('pay.edit');
    Route::post('/{payment}/edit','Backend\ReportController@updatePayment')->name('pay.update');
    Route::delete('/{payment}/destroy','Backend\ReportController@delete')->name('pay.delete');

     //Terms and Conditions
     Route::prefix('terms-and-conditions')->group(function (){
        Route::get('/','Backend\TermsNConditionsController@index')->name('terms.and.conditions.view');
        Route::get('/add','Backend\TermsNConditionsController@create')->name('terms.and.conditions.add');
        Route::post('/add','Backend\TermsNConditionsController@store')->name('terms.and.conditions.store');
        Route::get('/{term}/edit','Backend\TermsNConditionsController@edit')->name('terms.and.conditions.edit');
        Route::post('/{term}/edit','Backend\TermsNConditionsController@update')->name('terms.and.conditions.update');
        Route::delete('/{term}/destroy','Backend\TermsNConditionsController@delete')->name('terms.and.conditions.delete');
    });

    //Privacy Policy
    Route::prefix('privacy-policy')->group(function (){
        Route::get('/','Backend\PrivacyPolicyController@index')->name('privacy.policy.view');
        Route::get('/add','Backend\PrivacyPolicyController@create')->name('privacy.policy.add');
        Route::post('/add','Backend\PrivacyPolicyController@store')->name('privacy.policy.store');
        Route::get('/{policy}/edit','Backend\PrivacyPolicyController@edit')->name('privacy.policy.edit');
        Route::post('/{policy}/edit','Backend\PrivacyPolicyController@update')->name('privacy.policy.update');
        Route::delete('/{policy}/destroy','Backend\PrivacyPolicyController@delete')->name('privacy.policy.delete');
    });

    //About Us
    Route::prefix('about-us')->group(function () {
        Route::get('/','Backend\AboutUsController@index')->name('about.us.view');
        Route::get('/add','Backend\AboutUsController@create')->name('about.us.add');
        Route::post('/add','Backend\AboutUsController@store')->name('about.us.store');
        Route::get('/{about}/edit','Backend\AboutUsController@edit')->name('about.us.edit');
        Route::post('/{about}/edit','Backend\AboutUsController@update')->name('about.us.update');
        Route::delete('/{about}/destroy','Backend\AboutUsController@delete')->name('about.us.delete');
    });

    //Header Settings
    Route::prefix('header')->group(function () {
        Route::get('/','Backend\HeaderController@index')->name('header.view');
        Route::post('/add','Backend\HeaderController@store')->name('header.store');
        Route::post('/{header}/edit','Backend\HeaderController@update')->name('header.update');
        Route::delete('/{header}/destroy','Backend\HeaderController@delete')->name('header.delete');
    });

     //Menu
     Route::prefix('menu')->group(function () {
        Route::get('/','Backend\MenuController@index')->name('menu.view');
        Route::get('/add','Backend\MenuController@create')->name('menu.add');
        Route::post('/add','Backend\MenuController@store')->name('menu.store');
        Route::get('/{menu}/edit','Backend\MenuController@edit')->name('menu.edit');
        Route::post('/{menu}/edit','Backend\MenuController@update')->name('menu.update');
        Route::delete('/{menu}/destroy','Backend\MenuController@delete')->name('menu.delete');
    });
    //Sub Menu
    Route::prefix('sub-menu')->group(function () {
        Route::get('/','Backend\SubMenuController@index')->name('sub.menu.view');
        Route::get('/add','Backend\SubMenuController@create')->name('sub.menu.add');
        Route::post('/add','Backend\SubMenuController@store')->name('sub.menu.store');
        Route::get('/{sub}/edit','Backend\SubMenuController@edit')->name('sub.menu.edit');
        Route::post('/{sub}/edit','Backend\SubMenuController@update')->name('sub.menu.update');
        Route::delete('/{sub}/destroy','Backend\SubMenuController@delete')->name('sub.menu.delete');
    });

    //Service Area
    Route::prefix('service-area')->group(function () {
        Route::get('/','Backend\ServiceController@index')->name('service.view');
        Route::get('/add','Backend\ServiceController@create')->name('service.add');
        Route::post('/add','Backend\ServiceController@store')->name('service.store');
        Route::get('/{service}/edit','Backend\ServiceController@edit')->name('service.edit');
        Route::post('/{service}/edit','Backend\ServiceController@update')->name('service.update');
        Route::delete('/{service}/destroy','Backend\ServiceController@delete')->name('service.delete');
    });

    //Advertise Area
    Route::prefix('advertise')->group(function() {
        Route::get('/view','Backend\AdvertisesController@view')->name('advertise.view');
        Route::get('/edit/{id}','Backend\AdvertisesController@edit')->name('advertise.edit');
        Route::post('/update/{id}','Backend\AdvertisesController@update')->name('advertise.update');
    });

    //Featured Area
    Route::prefix('featured-area')->group(function() {
        Route::get('/index','Backend\FeaturedProductsController@index')->name('featured-area.index');
        Route::get('/edit/{id}','Backend\FeaturedProductsController@edit')->name('featured-area.edit');
        Route::post('/update/{id}','Backend\FeaturedProductsController@update')->name('featured-area.update');
    });

    //Video Area
    Route::prefix('video-area')->group(function() {
        Route::get('/view','Backend\VideoAreaController@view')->name('video-area.view');
        Route::get('/edit/{id}','Backend\VideoAreaController@edit')->name('video-area.edit');
        Route::post('/update/{id}','Backend\VideoAreaController@update')->name('video-area.update');
    });

    //Social Area
    Route::prefix('social')->group(function() {
        Route::get('/view','Backend\SocialsController@view')->name('social.view');
        Route::get('/edit/{id}','Backend\SocialsController@edit')->name('social.edit');
        Route::post('/update/{id}','Backend\SocialsController@update')->name('social.update');
    });

    //About Service Area
    Route::prefix('about-service')->group(function() {
        Route::get('/index','Backend\AboutServiceController@index')->name('about-service.index');
        Route::get('/edit/{id}','Backend\AboutServiceController@edit')->name('about-service.edit');
        Route::post('/update/{id}','Backend\AboutServiceController@update')->name('about-service.update');
    });
...
Route::prefix('admin')->group(function () {
 ...
 //Seo
     Route::prefix('seo')->group(function (){
        Route::get('/','Backend\SeoController@index')->name('seo.view');
        Route::get('/add','Backend\SeoController@create')->name('seo.add');
        Route::post('/add','Backend\SeoController@store')->name('seo.store');
        Route::get('/{seo}/edit','Backend\SeoController@edit')->name('seo.edit');
        Route::post('/{seo}/edit','Backend\SeoController@update')->name('seo.update');
        Route::delete('/{seo}/destroy','Backend\SeoController@delete')->name('seo.delete');
    });

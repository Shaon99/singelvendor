...
//                                                         <div class="product-price-2 mb-3">
//                                                                ${price}
//                                                         </div>
//                                                     </div>
...
//                                                             ${price}
//                                                         </div>
//                                                         <div class="pro-add-to-cart mb-3">
//                                                             <a href="/${data[i].id}/product-details">
            ...
            success: function (data) {
                ...
                if (data.length > 0) {
                    ...
                    for (let i = 0; i < data.length; i++) {
                        ...
                        var addToCartBtn = '';
                        if (data[i].stock > 0){
                            addToCartBtn = `<a href="/${data[i].id}/product-details">
                                                                <button title="Add to Cart">Add To Cart</button>
                                                            </a>`
                        }else{
                            addToCartBtn = `<a href="/${data[i].id}/product-details">
                                                                <button title="Out of Stock" disabled>Out of Stock</button>
                                                            </a>`
                        }
                        shopArea.append(`
                            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 singleProduct">
                                                <div class="single-product-wrap rounded mt-4 mb-4 shadow p-2">
                                                    <div class="product-img product-img-zoom mb-15 text-center">
                                                        ...
                                                        <div class="product-action-2 tooltip-style-2">
                                                            ...
                                                            <a href="/add-to-wishlist/${data[i].id}">
                                                                 <button data-id=${data[i].id} class="addTowishlist" title="Wishlist"><i class="icon-heart"></i></button>
                                                            </a>
                                                            <button class="q_m_btn" id="quickView_modal_btn"
                                                                data-id=${data[i].id} title="Quick View"><i
